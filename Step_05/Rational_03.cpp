//https://stepik.org/lesson/559/step/6?unit=882
...
Rational operator/(Rational lhs, Rational rhs);
    ...
    bool operator==(Rational const& r1, Rational const& r2) {return(!(r1 < r2) && !(r2 < r1));}
    bool operator!=(Rational const& r1, Rational const& r2) {return !(r1 == r2);}    
    bool operator> (Rational const& r1, Rational const& r2) {return (r2 < r1);}
    bool operator<=(Rational const& r1, Rational const& r2) {return !(r2 < r1);}
    bool operator>=(Rational const& r1, Rational const& r2) {return !(r1 < r2);}
    bool operator< (int const& i,       Rational const& r)  {return Rational(i) < r;}
